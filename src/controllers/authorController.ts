...
export const createAuthor = async (req: Request, res: Response) => {
  try {
    ...
    console.log('Creating author with data:', { name, email, bio, title });
    ...
    // Check if author with email already exists (only if email is provided)
    if (email) {
    ...
    // Create author - slug will be auto-generated by the model's pre-save hook
